...
- [x] 5.1 `openspec/specs/rope-target-setup/spec.md`
- [x] 5.2 `openspec/specs/rope-core-types/spec.md`
- [x] 5.3 `openspec/specs/rope-insert/spec.md`
- [x] 5.4 `openspec/specs/rope-delete/spec.md`
- [x] 5.5 `openspec/specs/rope-replace/spec.md`
- [x] 5.6 `openspec/specs/rope-utf16-navigation/spec.md`
- [x] 5.7 `openspec/specs/rope-buffer-conformance/spec.md`
- [x] 5.8 `openspec/specs/rope-buffer-drift/spec.md`
- [x] 5.9 `openspec/specs/rope-edge-cases/spec.md`
- [x] 5.10 `openspec/specs/rope-stress-testing/spec.md`
- [x] 5.11 `openspec/specs/rope-transfer-convergence/spec.md`
- [x] 5.12 Confirm no `TBD` placeholder remains under `openspec/specs/` (`grep -rn "TBD" openspec/specs/` returns nothing).

## 6. Verification

- [x] 6.1 `swift build` — the new marker in `TextAnalysisCapable.swift` sits inside an `@inlinable` body; confirm it compiles.
- [x] 6.2 `swift test` — confirm the suite is still green. No test changes are expected; if any test asserts on doc-comment-adjacent behavior, that is a finding, not an edit.
- [x] 6.3 `openspec validate docs-rope-disclosure --strict` — confirm the `MODIFIED` delta against `rope-buffer-conformance` resolves and the Purpose edits did not disturb any requirement.
