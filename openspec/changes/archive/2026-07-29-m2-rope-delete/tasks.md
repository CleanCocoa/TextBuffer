...
- [x] 7.2 Write test for repeated deletions that shrink the tree from 3+ levels down to a single leaf, verify final `content` matches expected string and root summary matches `Summary.of(content)`
